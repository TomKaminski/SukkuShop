...
namespace SukkuShop.Controllers
{
    ...
    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public partial class T4MVC_PreviewController : SukkuShop.Controllers.PreviewController
    {
        public T4MVC_PreviewController() : base(Dummy.Instance) { }

        [NonAction]
        partial void ExampleOverride(T4MVC_System_Web_Mvc_ActionResult callInfo);
