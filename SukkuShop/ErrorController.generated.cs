...
namespace SukkuShop.Controllers
{
    public partial class ErrorController
    {
        ...
        {
            public readonly string Blad404 = "Blad404";
        ...
        {
            public const string Blad404 = "Blad404";
        ...
        public class ViewsClass
        {
            ...
            public readonly string Blad404 = "~/Views/Error/Blad404.cshtml";
            public readonly string Error = "~/Views/Error/Error.cshtml";
        }
    }

    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public partial class T4MVC_ErrorController : SukkuShop.Controllers.ErrorController
    {
        public T4MVC_ErrorController() : base(Dummy.Instance) { }

        [NonAction]
        partial void Blad404Override(T4MVC_System_Web_Mvc_ActionResult callInfo);

        [NonAction]
        public override System.Web.Mvc.ActionResult Blad404()
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.Blad404);
            Blad404Override(callInfo);
            return callInfo;
        }
