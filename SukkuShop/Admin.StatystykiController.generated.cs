...
{
    public partial class StatystykiController
    {
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        protected StatystykiController(Dummy d) { }
        ...
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public StatystykiController Actions { get { return MVC.Admin.Statystyki; } }
        [GeneratedCode("T4MVC", "2.0")]
        public readonly string Area = "Admin";
        [GeneratedCode("T4MVC", "2.0")]
        public readonly string Name = "Statystyki";
        [GeneratedCode("T4MVC", "2.0")]
        public const string NameConst = "Statystyki";
        ...
        public class ViewsClass
        {
            ...
            public readonly string Index = "~/Areas/Admin/Views/Statystyki/Index.cshtml";
        }
    }

    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public partial class T4MVC_StatystykiController : SukkuShop.Areas.Admin.Controllers.StatystykiController
    {
        public T4MVC_StatystykiController() : base(Dummy.Instance) { }
        ...
        [NonAction]
        partial void GetOrderDataOverride(T4MVC_System_Web_Mvc_JsonResult callInfo);

        [NonAction]
        public override System.Web.Mvc.JsonResult GetOrderData()
        {
